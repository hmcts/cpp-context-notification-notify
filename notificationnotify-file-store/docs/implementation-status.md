...
| Ticket | Title | Points | Status |
|---|---|---|---|
| BYOFS-3.1 | Service Bus message contract spec for UC2.1 | 2 | ❌ Not started |
| BYOFS-3.2 | No-persistence stream-through convention spec | 2 | ❌ Not started |
| BYOFS-3.3 | Reference example: receiver-side stream-to-sink | 5 | ❌ Not started |
| BYOFS-3.4 | Integration test: owner upload → SB message → receiver stream-to-sink | 5 | ❌ Not started |
| BYOFS-3.5 | Adopter onboarding guide for UC2.1 | 3 | ❌ Not started |
| BYOFS-3.6 | Pilot integration: `mi-reportdata → notification-notify` | 3 | ❌ Not started |
